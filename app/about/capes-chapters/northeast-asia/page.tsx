...
export const metadata: Metadata = {
  title: "Northeast Asia Chapter",
  description:
    "CAPES Northeast Asia Chapter — research, partnerships, and events tracking geopolitics in China, Japan, and the Koreas, and Pakistan's engagement with Northeast Asia.",
};
    ...
    <div className="w-full min-h-screen bg-[#f1f4f8] py-12 px-4 flex flex-col items-center">
      ...
      <div className="max-w-2xl text-center mb-10">
        ...
        <p className="mt-3 text-sm md:text-base text-neutral-600">
          CAPES's Northeast Asia Chapter follows developments in China, Japan, and the Koreas, and Pakistan's growing engagement with the region, through dedicated research, partnerships, and events.
        </p>
      </div>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button className={buttonBaseClass}>
          <div className="flex flex-col items-center leading-tight">
            <span className="text-lg font-bold tracking-tight uppercase">About Northeast-Asia</span>
        ...
        <button className={buttonBaseClass}>
          <div className="flex flex-col items-center leading-tight">
            <span className="text-lg font-bold tracking-tight uppercase">Northeast-Asia Team</span>
        ...
        <button className={buttonBaseClass}>
          <div className="flex flex-col items-center leading-tight">
            <span className="text-lg font-bold tracking-tight uppercase">Northeast-Asia Events</span>
        ...
        <button className={buttonBaseClass}>
          <div className="flex flex-col items-center leading-tight">
            <span className="text-lg font-bold tracking-tight uppercase">Northeast-Asia Monitor</span>
