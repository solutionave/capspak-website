...
export const metadata: Metadata = {
  title: "Weekly News Monitor – May 26-30, 2025",
  description:
    "CAPES Weekly News Monitor for May 26-30, 2025 — curated Asia-Pacific and Eurasian news summaries organized by category.",
};
