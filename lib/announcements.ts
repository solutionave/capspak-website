...
const announcements: Announcement[] = [
  {
    ...
    message: 'You are viewing the preview deployment of the new CAPSPak site. Feedback welcome.',
    level: 'info',
    start: '2025-08-01',
    end: '2025-09-30',
  ...
  },
  {
    ...
    message: 'Limited seats available for our September roundtable on regional space governance.',
...
export function getActiveAnnouncements(date: Date = new Date()): Announcement[] {
